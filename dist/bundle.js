...
/***/ function(module, exports, __webpack_require__) {
	...
	var _nodeNotifier = __webpack_require__(153);
	
	var _nodeNotifier2 = _interopRequireDefault(_nodeNotifier);
	
	var _del = __webpack_require__(154);
	
	var _del2 = _interopRequireDefault(_del);
	
	var _containersAppContainer = __webpack_require__(199);
	
	var _containersAppContainer2 = _interopRequireDefault(_containersAppContainer);
	
	var _utilsDotaDotaWatcherJs = __webpack_require__(200);
	
	var _utilsDotaDotaWatcherJs2 = _interopRequireDefault(_utilsDotaDotaWatcherJs);
	
	var _utilsDotaConfigJs = __webpack_require__(205);
	
	var _utilsDotaConfigJs2 = _interopRequireDefault(_utilsDotaConfigJs);
	
	__webpack_require__(206);
	
	_utilsDotaConfigJs2['default'].setUpAutoExec().then(function () {
	  return console.log('Autoexec is set up!');
	});
	
	_utilsDotaDotaWatcherJs2['default'].on('start', function () {
	...
	_utilsDotaDotaWatcherJs2['default'].on('heroPick', function (hero) {
	  return _nodeNotifier2['default'].notify({
	...
	_utilsDotaDotaWatcherJs2['default'].on('stop', function () {
	  console.log('Dota stopped running!');
	  (0, _del2['default'])([consolePath], { force: true }).then(function (paths) {
	    return console.log('Finished deleting console.log');
	  });
	});
	
	(0, _reactDom.render)(_react2['default'].createElement(_containersAppContainer2['default'], null), document.getElementById('react-root'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var globby = __webpack_require__(156);
	var isPathCwd = __webpack_require__(181);
	var isPathInCwd = __webpack_require__(182);
	var objectAssign = __webpack_require__(161);
	var Promise = __webpack_require__(157);
	var pify = __webpack_require__(180);
	var rimraf = __webpack_require__(185);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var objectAssign = __webpack_require__(161);
	var glob = __webpack_require__(162);
	var arrify = __webpack_require__(179);
	var pify = __webpack_require__(180);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = global.Promise || __webpack_require__(158);
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	var arrayUniq = __webpack_require__(160);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var inflight = __webpack_require__(175)
	var util = __webpack_require__(173)
	var childrenIgnored = common.childrenIgnored
	var isIgnored = common.isIgnored
	
	var once = __webpack_require__(177)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var minimatch = __webpack_require__(164)
	var Minimatch = minimatch.Minimatch
	var Glob = __webpack_require__(162).Glob
	var util = __webpack_require__(173)
	var path = __webpack_require__(155)
	var assert = __webpack_require__(170)
	var isAbsolute = __webpack_require__(171)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var wrappy = __webpack_require__(178)
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	var isPathInside = __webpack_require__(183);
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	var path = __webpack_require__(155);
	var pathIsInside = __webpack_require__(184);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var fs = __webpack_require__(163)
	var minimatch = __webpack_require__(187)
	var Minimatch = minimatch.Minimatch
	var inherits = __webpack_require__(191)
	var EE = __webpack_require__(169).EventEmitter
	var path = __webpack_require__(155)
	var assert = __webpack_require__(170)
	var isAbsolute = __webpack_require__(192)
	var globSync = __webpack_require__(193)
	var common = __webpack_require__(194)
	var alphasort = common.alphasort
	var alphasorti = common.alphasorti
	var setopts = common.setopts
	var ownProp = common.ownProp
	var inflight = __webpack_require__(195)
	var util = __webpack_require__(173)
	var childrenIgnored = common.childrenIgnored
	var isIgnored = common.isIgnored
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GLOBSTAR = minimatch.GLOBSTAR = Minimatch.GLOBSTAR = {}
	var expand = __webpack_require__(188)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var concatMap = __webpack_require__(189);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _child_process = __webpack_require__(201);
	
	var _events = __webpack_require__(169);
	
	var _events2 = _interopRequireDefault(_events);
	
	var _rsvp = __webpack_require__(202);
	
	var _varsJs = __webpack_require__(203);
	
	var _fs = __webpack_require__(163);
	
	var _fs2 = _interopRequireDefault(_fs);
	
	var _fsJs = __webpack_require__(204);
	
	var TIMEOUT_CHECK = 500;
	var gameInit = 'C:Gamerules: entering state \'DOTA_GAMERULES_STATE_INIT\'';
	var gameEnd = 'Game: "Dota 2"\r\nMap: "<empty>"';
	var rePlayerTeam = /Game event "player_team", Tick \d+:\r\n- "userid" = "(\d+)"/;
	
	var dotaRunning = null;
	var lastHero = null;
	var lastGameNum = null;
	
	var DotaWatcher = new _events2['default']();
	
	function isDotaRunning() {
	  return new _rsvp.Promise(function (resolve, reject) {
	    if (process.platform === 'win32') {
	      (0, _child_process.exec)('tasklist', {
	        encoding: 'utf8'
	      }, function (err, stdout, stderr) {
	        if (stdout) {
	          var dotaProcs = stdout.split(/\r?\n/).filter(function (name) {
	            return name.startsWith('dota2');
	          });
	...
	*/
	...
	function findHero(consoleData) {
	  //If the condump contains multiple games, make sure we get the most recent one
	  var parts = consoleData.split(gameInit);
	  var gameNum = parts.length - 1;
	  var gameData = parts[gameNum];
	  ...
	  //Look for the userId
	  var userIds = rePlayerTeam.exec(gameData);
	  ...
	  if (userIds) {
	    ...
	    var reHeroPick = new RegExp('Game event "dota_player_pick_hero", Tick \\d+:\r\n- "player" = "' + userId + '"\r\n- "heroindex" = "\\d+"\r\n- "hero" = "npc_dota_hero_([a-z_]+)"');
	
	    //Look for the hero picks
	    var heroPick = reHeroPick.exec(gameData);
	
	    if (heroPick) {
	      return { hero: heroPick[1], gameNum: gameNum };
	    }
	...
	function watchDota() {
	  isDotaRunning().then(function (newDotaRunning) {
	    ...
	    return (0, _fsJs.readFile)(_varsJs.consolePath);
	  }).then(function (data) {
	    if (data && data.length > 0) {
	      var heroData = findHero(data);
	
	      if (heroData) {
	        var hero = heroData.hero;
	        var gameNum = heroData.gameNum;
	  ...
	  ['finally'](function () {
	    return setTimeout(watchDota, TIMEOUT_CHECK);
	  });
	}
	
	watchDota();
	
	exports['default'] = DotaWatcher;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var dotaPath = _path2['default'].resolve('/', 'Program Files (x86)', 'Steam', 'steamapps', 'common', 'dota 2 beta', 'game', 'dota');
	exports.dotaPath = dotaPath;
	var consolePath = _path2['default'].resolve(dotaPath, 'console.log');
	exports.consolePath = consolePath;
	var autoexecPath = _path2['default'].resolve(dotaPath, 'cfg', 'autoexec.cfg');
	exports.autoexecPath = autoexecPath;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var pFs = {
	  ...
	  */
	  ...
	  writeFile: function writeFile(fileName, data, options) {
	    return new _rsvp.Promise(function (resolve, reject) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _fsJs2 = _interopRequireDefault(_fsJs);
	
	var reConfigSection = /\/{3}dota2-configurator start[A-z0-9_\n\r\-\s\/!]+\/{3}dota2-configurator end/;
	
	var dotaConfig = '///dota2-configurator start\n///DO NOT CHANGE THESE SETTINGS!\nlog_flags console -consoleonly\ncl_net_showevents 1\nhideconsole\n///dota2-configurator end';
	
	var DotaConfig = {
	  setUpAutoExec: function setUpAutoExec() {
	    return _fsJs2['default'].fileExists(_varsJs.autoexecPath).then(function (exists) {
	      return exists ? _fsJs2['default'].readFile(_varsJs.autoexecPath) : '';
	    }).then(function (configData) {
	      return _fsJs2['default'].writeFile(_varsJs.autoexecPath, '' + configData.replace(reConfigSection, '') + dotaConfig);
	    });
	  }
	};
	
	exports['default'] = DotaConfig;
	module.exports = exports['default'];
